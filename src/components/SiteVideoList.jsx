...
export default function SiteVideoList({ data }) {
  ...
  return <>
    <div className="pt-4 flex flex-row-reverse items-center gap-3">
      <Button className="self-end" onClick={handleAddAll}>全部加入队列</Button>
    </div>
    <div className="mt-4 rounded-xl border border-dashed border-cyan-300 p-4">
      <Table className="">
        <TableHeader>
          <TableRow>
